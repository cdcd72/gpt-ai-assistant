const zh = {
  ...
  __COMMAND_TRANSLATE_TO_ZH_LABEL: '上一句翻成中文',
  __COMMAND_TRANSLATE_TO_ZH_TEXT: '上一句翻成中文',
  __COMMAND_TRANSLATE_TO_ZH_PROMPT: (lang) => `${lang === 'zh_TW' ? '將以下內容翻譯成繁體中文' : '将以下内容翻译成简体中文'}。`,
  __COMPLETION_DEFAULT_SYSTEM_PROMPT: (lang) => `${lang === 'zh_TW' ? '以下將使用繁體中文進行對話' : '以下将使用简体中文进行对话'}。`,
